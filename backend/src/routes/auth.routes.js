...
import { authLimiter, googleAuthLimiter } from '../middleware/rateLimiter.js';
import { requireAuth, requireCsrf } from '../middleware/auth.js';
import { validate } from '../middleware/validate.js';
import { googleLoginSchema, loginSchema, registerSchema } from '../validators/auth.schema.js';
...
router.post('/google',   googleAuthLimiter, validate({ body: googleLoginSchema }), googleLogin);
